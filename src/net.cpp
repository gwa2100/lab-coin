...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Labcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"labcoin.timmymx.com", "labcoin.timmymx.com"},
    {"coin.bytepen.com","coin.bytepen.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"labcointools.com", "testnet-seed.labcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Labcoin is probably already running."), addrBind.ToString().c_str());
        else
